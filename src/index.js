...
export function contextValue(key, value) {
...
export function makeProblem(status, title = STATUS_TEXT[status] || 'Error', extras = {}) {
  const problem = {
...
export function withTimeout(work, timeoutMs, message = 'Operation timed out') {
...
export function smartJson(options = {}) {
